        ...
        <form action="{{ route('business.plans.store') }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input id="duration" name="duration" type="number" min="15" max="480" value="{{ old('duration', 60) }}" class="w-full border rounded px-3 py-2" required>
                ...
                <div>
                    ...
                    <input id="max_bookings_per_day" name="max_bookings_per_day" type="number" min="1" value="{{ old('max_bookings_per_day') }}" class="w-full border rounded px-3 py-2">
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input id="price" name="price" type="number" step="0.01" min="0" value="{{ old('price') }}" class="w-full border rounded px-3 py-2" required>
            ...
            <div class="mb-4">
                <label class="flex items-center">
                    <input type="checkbox" name="requires_deposit" value="1" {{ old('requires_deposit') ? 'checked' : '' }} class="mr-2" onchange="toggleDepositAmount(this)">
                    <span class="text-sm font-medium">Requires Deposit</span>
                </label>
            </div>

            <div class="mb-4" id="deposit_amount_field" style="display: {{ old('requires_deposit') ? 'block' : 'none' }};">
                <label class="block text-sm font-medium mb-1" for="deposit_amount">Deposit Amount</label>
                <input id="deposit_amount" name="deposit_amount" type="number" step="0.01" min="0" value="{{ old('deposit_amount') }}" class="w-full border rounded px-3 py-2">
